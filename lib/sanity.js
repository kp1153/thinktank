...
export async function getAllPosts() {
  try {
    ...
    return posts.map((post) => ({
      ...post,
      mainImageUrl: post.mainImage ? urlFor(post.mainImage) : null,
...
// 4. Get all categories with parent info
...
// 6. Get recent posts (Sidebar/Featured)
